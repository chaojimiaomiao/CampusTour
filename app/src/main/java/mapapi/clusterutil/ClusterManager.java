...
import mapapi.clusterutil.algo.Algorithm;
import mapapi.clusterutil.algo.NonHierarchicalDistanceBasedAlgorithm;
import mapapi.clusterutil.algo.PreCachingAlgorithmDecorator;
import mapapi.clusterutil.view.ClusterRenderer;
import mapapi.clusterutil.view.DefaultClusterRenderer;
import com.baidu.mapapi.map.BaiduMap;
import com.baidu.mapapi.map.MapStatus;
import com.baidu.mapapi.map.Marker;
import mapapi.clusterutil.*;
import mapapi.clusterutil.Cluster;
import mapapi.clusterutil.ClusterItem;
 ...
 * <li>
 */
public class ClusterManager<T extends mapapi.clusterutil.ClusterItem> implements
        BaiduMap.OnMapStatusChangeListener, BaiduMap.OnMarkerClickListener {
    private final mapapi.clusterutil.MarkerManager mMarkerManager;
    private final mapapi.clusterutil.MarkerManager.Collection mMarkers;
    private final mapapi.clusterutil.MarkerManager.Collection mClusterMarkers;
    ...
    public ClusterManager(Context context, BaiduMap map) {
        this(context, map, new mapapi.clusterutil.MarkerManager(map));
    }

    public ClusterManager(Context context, BaiduMap map, mapapi.clusterutil.MarkerManager markerManager) {
        mMap = map;
    ...
    public mapapi.clusterutil.MarkerManager.Collection getMarkerCollection() {
        return mMarkers;
    }

    public mapapi.clusterutil.MarkerManager.Collection getClusterMarkerCollection() {
        return mClusterMarkers;
    }

    public mapapi.clusterutil.MarkerManager getMarkerManager() {
     ...
     */
    private class ClusterTask extends AsyncTask<Float, Void, Set<? extends mapapi.clusterutil.Cluster<T>>> {
        @Override
        protected Set<? extends mapapi.clusterutil.Cluster<T>> doInBackground(Float... zoom) {
        ...
        @Override
        protected void onPostExecute(Set<? extends mapapi.clusterutil.Cluster<T>> clusters) {
     ...
     */
    public interface OnClusterClickListener<T extends mapapi.clusterutil.ClusterItem> {
        public boolean onClusterClick(mapapi.clusterutil.Cluster<T> cluster);
    }

    /**
     * Called when a Cluster's Info Window is clicked.
     */
    public interface OnClusterInfoWindowClickListener<T extends mapapi.clusterutil.ClusterItem> {
     ...
     */
    public interface OnClusterItemClickListener<T extends mapapi.clusterutil.ClusterItem> {
