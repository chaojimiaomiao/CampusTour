...
package mapapi.clusterutil.view;
...
import mapapi.clusterutil.ClusterManager;
...
import static mapapi.clusterutil.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        mapapi.clusterutil.view.ClusterRenderer<T> {
