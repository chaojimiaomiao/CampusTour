...
package mapapi.clusterutil.algo;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, mapapi.clusterutil.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, mapapi.clusterutil.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                mapapi.clusterutil.algo.StaticCluster<T> cluster =
                        new mapapi.clusterutil.algo
